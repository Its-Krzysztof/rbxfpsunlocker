...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case RFU_TRAYICON:
	{
		if (lParam == WM_RBUTTONDOWN || lParam == WM_LBUTTONDOWN)
		{
			...
			AppendMenu(submenu, MF_STRING, RFU_FCS_30, "5");
			AppendMenu(submenu, MF_STRING, RFU_FCS_30, "10");
			AppendMenu(submenu, MF_STRING, RFU_FCS_30, "15");
			AppendMenu(submenu, MF_STRING, RFU_FCS_30, "20");
			AppendMenu(submenu, MF_STRING, RFU_FCS_30, "25");
